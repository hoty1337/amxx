...
#define PLUGIN "Magic Marker Simon"
#define VERSION "3.2"
#define AUTHOR "DpyrBarni"
...
public paint_handler(id)
{
	...
	if(!is_user_alive(id))
	{
		client_print(id, print_chat, "* Вы не можете использовать волшебный маркер, когда вы мертвы.")
		return PLUGIN_HANDLED
	}
...
{
	if(!jbm_is_user_chief(id)) return PLUGIN_HANDLED;
